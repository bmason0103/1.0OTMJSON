...
//                if let user = results?[parametersAll.StudentLocation.objectId] as? NSDictionary {
                if let last_name = results?[parametersAll.StudentLocation.lastName] as? NSDictionary {
//                    if let first_name = user[parametersAll.StudentLocation.firstName] as? String,
//                    if  let last_name = user[parametersAll.StudentLocation.lastName] as? String
                    if  let last_name = last_name[parametersAll.StudentLocation.lastName] as? String {
